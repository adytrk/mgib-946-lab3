...
def test_back_track_history_move(robot):
    robot.move()
    robot.back_track()
    state = robot.state()
    assert state['direction'] == Direction.NORTH
...
def test_back_track_history_turn(robot):
    robot.turn()
    robot.back_track()
    state = robot.state()
    assert state['direction'] == Direction.EAST
...
def test_back_track_history_multiple_moves(robot):
    robot.move()
    robot.move()
    robot.back_track()
    state = robot.state()
...
def test_multiple_back_track_history_multiple_moves(robot):
    robot.move()
    robot.move()
    robot.back_track()
    robot.move()
